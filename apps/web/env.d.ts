...
type _CoercedEnvSchema_93a593ff = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_93a593ff> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_93a593ff, 'DATABASE_URL' | 'APP_URL' | 'APP_INTERNAL_URL' | 'PORT' | 'INFISICAL_CLIENT_ID' | 'QUEUE_URL' | 'QUEUE_NAME' | 'ORIGIN' | 'GITHUB_CLIENT_ID' | 'GOOGLE_CLIENT_ID' | 'EMAIL_ADDRESS' | 'API_URL'>> {}
}
...
type _EnvSchemaAsStrings_93a593ff = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_93a593ff {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_93a593ff {}
  }
}