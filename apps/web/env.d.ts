...
type _CoercedEnvSchema_f6bec36c = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_f6bec36c> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_f6bec36c, 'INFISICAL_CLIENT_ID' | 'ORIGIN' | 'GITHUB_CLIENT_ID' | 'GOOGLE_CLIENT_ID' | 'EMAIL_ADDRESS' | 'QUEUE_URL' | 'QUEUE_NAME' | 'DATABASE_URL'>> {}
}
...
type _EnvSchemaAsStrings_f6bec36c = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_f6bec36c {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_f6bec36c {}
  }
}