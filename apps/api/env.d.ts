...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_31128aa9, 'DATABASE_URL' | 'ORIGIN' | 'GITHUB_CLIENT_ID' | 'GOOGLE_CLIENT_ID' | 'EMAIL_ADDRESS'>> {}
}
