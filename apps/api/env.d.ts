...
type _CoercedEnvSchema_f510b805 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_f510b805> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_f510b805, 'DATABASE_URL' | 'APP_URL' | 'APP_INTERNAL_URL' | 'PORT' | 'QUEUE_URL' | 'QUEUE_NAME'>> {}
}
...
type _EnvSchemaAsStrings_f510b805 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_f510b805 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_f510b805 {}
  }
}