...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_d25a5d68, 'INFISICAL_CLIENT_ID' | 'ORIGIN' | 'GITHUB_CLIENT_ID' | 'GOOGLE_CLIENT_ID' | 'EMAIL_ADDRESS' | 'DATABASE_URL'>> {}
}
