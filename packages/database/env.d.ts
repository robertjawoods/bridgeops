...
type _CoercedEnvSchema_6cbbe445 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_6cbbe445> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_6cbbe445, 'INFISICAL_CLIENT_ID' | 'ORIGIN' | 'GITHUB_CLIENT_ID' | 'GOOGLE_CLIENT_ID' | 'EMAIL_ADDRESS' | 'API_URL' | 'QUEUE_URL' | 'QUEUE_NAME' | 'DATABASE_URL'>> {}
}
...
type _EnvSchemaAsStrings_6cbbe445 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_6cbbe445 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_6cbbe445 {}
  }
}