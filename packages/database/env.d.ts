...
type _CoercedEnvSchema_621f9ace = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_621f9ace> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_621f9ace, 'ORIGIN' | 'GITHUB_CLIENT_ID' | 'GOOGLE_CLIENT_ID' | 'EMAIL_ADDRESS' | 'DATABASE_URL'>> {}
}
...
type _EnvSchemaAsStrings_621f9ace = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_621f9ace {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_621f9ace {}
  }
}